...
static esp_err_t status_handler(httpd_req_t *req) {
    ...
    sprintf(json_response, "{\"framesize\":%u,\"quality\":%u,\"brightness\":%d,\"special_effect\":%u,\"vflip\":%u,\"led_intensity\":%u}",
        s->status.framesize, s->status.quality, s->status.brightness, s->status.special_effect, s->status.vflip, led_duty);
...
// ----- Start the camera + stream servers -----
